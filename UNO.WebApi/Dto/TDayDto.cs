...
namespace UNO.WebApi.Dto
{
    public class TDayDto
    {
        ...
        public DateTime TDAY_INTIME { get; set; }
        public DateTime TDAY_OUTIME { get; set; }
        ...
        public string Tday_Status { get; set; }
