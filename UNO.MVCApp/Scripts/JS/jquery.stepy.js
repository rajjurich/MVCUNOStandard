...
; (function ($) {
    ...
    var methods = {
        init: function (settings) {
            ...
            var self = this,
                that = $(this),
                attributes = { href: '#', 'class': 'pull-left btn btn-default', html: self.opt.backLabel };
            ...
            var self = this,
                that = $(this),
                attributes = { href: '#', 'class': 'pull-right btn btn-primary', html: self.opt.nextLabel };
            ...
            return $('<div class="stepy-navigator form-group pb-n row"  />');
